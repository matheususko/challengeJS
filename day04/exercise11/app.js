...
// for (let i = 0; i < 5; i++) {
//     console.log(`dentro do block de código: ${name}`)
// }
// console.log(`fora do block de código: ${name}`)
...
/*
  ...
  - Você sabe por que isso aconteceu? R: pq a let só está disponível dentro do escopo da função
*/
