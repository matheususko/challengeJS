  ...
  */
      ...
      const getLikesMessage = (names = []) => {
        ...
        switch (names.length) {
            ...
            case 2:
                return `${firstName} e ${secondnNames} curtiram isso`
            case 3:
                return `${firstName}, ${secondnNames} e ${thirdNames} curtiram isso`
            default:
                return `${firstName}, ${secondnNames} e mais ${totalNamesMinusTwo} curtiram isso`
        }
      }
      
      console.log(getLikesMessage(['Matheus', 'Luan', 'Camila', 'Adison']))